...
alter table Sucursales add column `ID_NIF_FK` int not null;
...
alter table Direccion add column `CalleSucursal` varchar (20) not null;
alter table Direccion add column `LocalidadSucursal` varchar (20) not null;
...
alter table Telefono add column `TelefonoSucursal` integer (7) not null;
